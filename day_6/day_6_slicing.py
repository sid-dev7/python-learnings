...
#     # print values at even position
#     print(f"values at even positions = {numbers[0:10:2]}")
#     # print values at odd position
#     print(f"values at odd positions = {numbers[1:10:2]}")
# function_2()